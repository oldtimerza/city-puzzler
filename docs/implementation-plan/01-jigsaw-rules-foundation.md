...
- Three service types: Solar Panel, Dam, and Farm.
...
- Solar Panels and Dams may not be orthogonally adjacent.
...
- A placement detects cell, row, column, district, Solar Panel-Dam, and Farm-Dam conflicts.
